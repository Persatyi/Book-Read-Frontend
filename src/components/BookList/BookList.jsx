        ...
        >
          <ul className={s.readBookList}>
            <li className={s.readBookItem}>
              ...
              <p>
                A mental hospital in Lorem ipsum dolor sit amet, consectetur
                adipisicing elit. Recusandae, autem.
              </p>
              {/* {title} */}
            </li>
            <li className={s.readBookItem}>
              <span>Author:</span>Cooper Alan
              {/* author */}
            </li>
            <li className={s.readBookItem}>
              <span>Year:</span>2009
            ...
            <li className={s.readBookButton} onClick={onClick}>
              Resume
            </li>
          </ul>
        </li>
