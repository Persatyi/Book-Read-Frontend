        ...
        <ModalWrapper open={open} onClose={onClose}>
            <div className={s.modal}>
                ...
                <div className={s.btnBox}>
                    <Button className={s.button} type={"button"} styleType="transparent" text={"Відміна"} onClick={onClose} />
                    <Button className={s.button} type={"button"} text={"Вийти"} onClick={() => logoutFunc()} />
                </div>
            </div>
        </ModalWrapper>
    )
